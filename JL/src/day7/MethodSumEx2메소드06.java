...
public class MethodSumEx2메소드06 {

	public static void main(String[] args) {
		/*
		 * 예제1) 1부터 10까지 합을 출력하는 코드를 메소드를 이용해 작성해보세요
		 //sumAll1은 1부터 10까지 합이 고정이기 때문이기 때문에 5부터 10까지 합을 구할 수 있다
		 * */
		sumAll1();
		//sumAll2는 sumAll1보다는 낫다. 1에서 5까지 합을 구할수 있다.
		//5에서 10까지 합을 구할 수 없다
		sumAll2(10);
		//1에서 10까지의 합과 21에서 30까지의 합을 더한 값을 구할 때 사용할 수 없다.
		sumAll3(5,10);
		int begin = 1, int end = 10;
		System.out.println(begin + "부터" + end + "까지 합 : " + sumAll4(begin,end));
		int sum = sumAll4(1,10) + sumAll4(21,30);
		System.out.println("1에서 10까지의 합과 21에서 30까지의 합을 더한 것 : " + sum);
	}
	/* 에제1)
	 * 방법1) 
