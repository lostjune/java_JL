...
public class ExaListEx1 {
	...
	public static void main(String[] args) {
		/*
		 * list1은 ArrayList를 이용한 리스트이기 때문에 
		 * 생성자가 반드시 ArrayList이어야 함.
		 * list2는 List 인터페이스를 이용한 리스트이기 때문에 
		 * 생성자가 List 인터페이스를 구현한 구현클래스 아무나 올 수 있다
		 * 
		 * */
		...
		list1.addAll(list2); //전부 선택
		System.out.println("list1 : " + list1);
		System.out.println("list2 : " + list2);
		System.out.println("list1에 list2가 포함?" + list1.containsAll(list2));
		list1.removeAll(list2); //전부 삭제
		System.out.println("list1 : " + list1);
		System.out.println("list2 : " + list2);
		list1.clear(); //비워주기
		System.out.println("list1 : " + list1);
