...
public class IFMonthEx1월달력조건문04 {
	...
	public static void main(String[] args) {
		 ...
		 * 28 : 2
		 * month에 정수 입력 받고,
		 * month가 1월이면 31이라고 출력,
		 * month가 2월이면 28이라고 출력,
		 * month가 3월이면 31이라고 출력,
		 * month가 4월이면 30이라고 출력,
		 * month가 5월이면 31이라고 출력,
		 * month가 6월이면 30이라고 출력,
		 * month가 7월이면 31이라고 출력,
		 * month가 8월이면 31이라고 출력,
		 * month가 9월이면 30이라고 출력,
		 * month가 10월이면 31이라고 출력,
		 * month가 11월이면 30이라고 출력,
		 * month가 12월이면 31이라고 출력,
