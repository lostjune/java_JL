...
class Child1 extends Parent1{
	...
	public Child1(int x, int y, int z) {
		...
		//부모 클래스에 있는 생성자를 이용(사용)하는게 편하다
		//setX(x);  //setY(y);
		//super를 사용하는 이유는 setX와 Y를 한데 묶어서 사용하기 위함
		super(x, y);
		this.z = z;
	}
	/*
	 ...
	 * 자동으로 기본 생성자가 생성되고,
	 * 기본생성자 안에 부모 클래스의 기본 생성자가 호출된다.
	 * 이 때, 부모 클래스의 기본 생성자가 없는 경우 호출할 수 없어서 에러 발생
	 * 
	 * */
	/*public Child1() {
		super(); 
	...
	@Override
	public void print() {
		//부모에 있는 print를 이용하여 x,y를 출력하고 뒷부분을 직접 출력
		super.print();
